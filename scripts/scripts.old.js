      ...
      <div class="option">
        ...
        <label>
          ...
          <input
            ...
            onchange="atualizarProgresso(); selecionar(this)"
          >
...
function finalizarQuiz() {
  ...
  top3Global = Object.entries(contagem)
  ...
  document.getElementById("resultadoConteudo").innerHTML = top3Global
    .map(
      (item, index) => `
